...
import { Star, GitFork, Eye, ExternalLink, MessageSquare, AlertCircle, Calendar, Filter, Sparkles } from "lucide-react"
                              ...
                              {currentIssues.map((issue) => (
                                ...
                                >
                                  <div className="flex items-center justify-between mb-4">
                                    ...
                                    <Link href={`/client/repo/${params.owner}/${params.name}/issue/${issue.number}`}>
